...
table = os.getenv("Finder", "Finder")
api_key = os.getenv("00B66DBB75C1FFF08FC936C2E9CB3292")


class Database:
    def __init__(self, database=table):
        self.connection = psycopg2.connect(database=database, user="postgres", password="12345678")
...
def get_player_summaries(steamids, timeout=3):
    ...
    for index in range(0, len(steamids), 100):
        url = PLAYER_SUMMARIES_URL.format(api_key="00B66DBB75C1FFF08FC936C2E9CB3292", steamids=','.join(steamids[index:index+100]))
